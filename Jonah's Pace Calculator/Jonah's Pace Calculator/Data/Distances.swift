...
class Distances {
    ...
    static let fiftyKilometer = Distance(name: "50K", lengthInMiles: 50.0 * Convert.mileToKilometer)
    ...
    static let tenKilometer = Distance(name: "10K", lengthInMiles: 10.0 * Convert.mileToKilometer)
    static let eightKilometer = Distance(name: "8K", lengthInMiles: 8.0 * Convert.mileToKilometer)
    static let fiveKilometer = Distance(name: "5K", lengthInMiles: 5.0 * Convert.mileToKilometer)
    
    // Distances to be used in the Pace Section
    static let oneMile = Distance(name: "MILE", lengthInMiles: 1.0)
    static let oneKilometer = Distance(name: "KILOMETER", lengthInMiles: 1.0 * Convert.mileToKilometer)
